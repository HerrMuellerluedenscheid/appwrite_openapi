...
**min** | Option<**f64**> | Minimum value to enforce for new documents. | [optional]
**max** | Option<**f64**> | Maximum value to enforce for new documents. | [optional]
**default** | Option<**f64**> | Default value for attribute when not provided. Cannot be set when attribute is required. | [optional]
