...
pub struct DatabasesUpdateEnumAttributeRequest {
...
impl DatabasesUpdateEnumAttributeRequest {
    pub fn new(elements: Vec<String>, required: bool, default: Option<String>) -> DatabasesUpdateEnumAttributeRequest {
