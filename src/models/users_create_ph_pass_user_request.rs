...
pub struct UsersCreatePhPassUserRequest {
...
impl UsersCreatePhPassUserRequest {
    pub fn new(user_id: String, email: String, password: String) -> UsersCreatePhPassUserRequest {
