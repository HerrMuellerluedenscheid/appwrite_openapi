...
pub struct DatabasesCreateEnumAttributeRequest {
    /// Attribute Key.
    #[serde(rename = "key")]
    pub key: String,
...
impl DatabasesCreateEnumAttributeRequest {
    pub fn new(key: String, elements: Vec<String>, required: bool) -> DatabasesCreateEnumAttributeRequest {
