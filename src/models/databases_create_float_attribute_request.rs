...
pub struct DatabasesCreateFloatAttributeRequest {
    /// Attribute Key.
    #[serde(rename = "key")]
    pub key: String,
...
impl DatabasesCreateFloatAttributeRequest {
    pub fn new(key: String, required: bool) -> DatabasesCreateFloatAttributeRequest {
